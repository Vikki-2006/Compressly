...
_DEFAULT_DEV_SECRET = "compressly-dev-secret-do-not-use-in-production"
SECRET_KEY: str = os.environ.get("SECRET_KEY", _DEFAULT_DEV_SECRET)
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 60

# Safety guard: refuse to start with the default secret in a production-like env
if os.environ.get("ENV", "development").lower() == "production" and SECRET_KEY == _DEFAULT_DEV_SECRET:
    raise RuntimeError(
